...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='uwu ({})'.format(BOTVERSION), icon_url='https://imgur.com/gallery/xLxVNGT')
    ...
    async def cmd_cuddle(self, author, user_mentions):
        ...
        """
        if not user_mentions:
            return Response(self.str.get('cmd-cuddle-response', 'cuddles with **GoodDragon**!').format(author.id), reply=True, delete_after=35)
        else:
            usr = user_mentions[0]
            return Response(self.str.get('cmd-cuddle-response-other', 'cuddles with **{0}**! How cuteee <3').format(usr.name, usr.id), reply=True, delete_after=35)
    ...
    async def cmd_snuggle(self, author, user_mentions):
        ...
        """
        if not user_mentions:
            return Response(self.str.get('cmd-snuggle-response', 'snuggles with **GoodDragon**!').format(author.id), reply=True, delete_after=35)
        else:
            usr = user_mentions[0]
            return Response(self.str.get('cmd-snuggle-response-other', 'snuggles with **{0}**! How cuteee <3').format(usr.name, usr.id), reply=True, delete_after=35)
    ...
    async def cmd_boop(self, author, user_mentions):
        ...
        """
        if not user_mentions:
            return Response(self.str.get('cmd-boop-response', 'boops **GoodDragon**!').format(author.id), reply=True, delete_after=60)
        else:
            usr = user_mentions[0]
            return Response(self.str.get('cmd-boop-response-other', 'boops **{0}**! How cuteee :3').format(usr.name, usr.id), reply=True, delete_after=60)
    ...
    async def cmd_hug(self, author, user_mentions):
        ...
        """
        if not user_mentions:
            return Response(self.str.get('cmd-hug-response', 'got hugged by **GoodDragon**!').format(author.id), reply=True, delete_after=60)
        else:
            usr = user_mentions[0]
            return Response(self.str.get('cmd-hug-response-other', 'tightly hugs **{0}**! How cuteee <3').format(usr.name, usr.id), reply=True, delete_after=60)
    ...
    async def cmd_pounce(self, author, user_mentions):
        ...
        """
        if not user_mentions:
            return Response(self.str.get('cmd-pounce-response', 'pounces on **GoodDragon**! how cute').format(author.id), reply=True, delete_after=60)
        else:
            usr = user_mentions[0]
            return Response(self.str.get('cmd-pounce-response-other', 'pounces on **{0}** and they made both happily! how cute.').format(usr.name, usr.id), reply=True, delete_after=60)
